        ...
        <main className={styles.pollPage}>
            <div className={styles.pollCard}>
                ...
                <div className={styles.pollHeader}>
                    <div className={styles.pollBadge}><img src="/logo.png" alt="" style={{ height: 16, width: 'auto', borderRadius: 3, verticalAlign: 'middle' }} /> PartyPal Poll</div>
                ...
                <div className={styles.pollFooter}>
                    <a href="/"><img src="/logo.png" alt="" style={{ height: 14, width: 'auto', borderRadius: 3, verticalAlign: 'middle' }} /> Powered by PartyPal</a>
                </div>
            </div>
        </main>
    )
