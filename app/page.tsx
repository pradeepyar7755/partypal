...
const FEATURES = [
  { icon: '🤖', title: 'AI Party Planner', desc: 'Claude generates personalized checklists, timelines, and budget breakdowns based on your event details.' },
...
const DEMO_SLIDES = [
  {
    ...
    content: (
      <div style={{textAlign:'center',padding:'2rem'}}>
        ...
        <p style={{color:'rgba(255,255,255,0.5)',fontSize:'0.82rem',marginBottom:'1rem'}}>From venue to entertainment — powered by Claude AI.</p>
