                            ...
                            <div>
                                ...
                                <div className={styles.sidebarCard}>
                                    ...
                                    <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.8rem' }}>
                                        <button onClick={() => setEditBudgetMode(!editBudgetMode)} style={{ flex: 1, padding: '0.5rem', background: editBudgetMode ? 'var(--teal)' : 'transparent', color: editBudgetMode ? '#fff' : 'var(--navy)', border: `1.5px solid ${editBudgetMode ? 'var(--teal)' : 'var(--border)'}`, borderRadius: 10, fontFamily: "'Nunito',sans-serif", fontWeight: 800, fontSize: '0.78rem', cursor: 'pointer', transition: 'all 0.2s' }}>{editBudgetMode ? '✓ Done' : '💰 Adjust Budget'}</button>
