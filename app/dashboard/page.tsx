        ...
        <main className="page-enter">
            ...
            <header className={styles.header}>
                <div className={styles.headerInner}>
                    ...
                    <p className={styles.headerSubtitle}>Create and manage your party plans — all powered by AI.</p>
                </div>
            </header>
                                ...
                                <div className={styles.sectionCard}>
                                    <div className={styles.cardHeader} style={{ flexDirection: 'column', gap: '0.4rem' }}>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', width: '100%', flexWrap: 'wrap' }}>
                                            <span className={`${styles.sourceBadge} ${styles.claudeBadge}`} style={{ fontSize: '0.58rem', padding: '0.08rem 0.35rem' }} title="Your event details are processed by Google AI. No personal names or contact info are sent.">AI Generated</span>
