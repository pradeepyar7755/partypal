    ...
    <main>
      <header className={styles.header}>
        <div className={styles.headerInner}>
          ...
          <div className={styles.eventBadge}>🤖 AI Generated by Claude</div>
        ...
        <div className={styles.planLayout}>
          ...
          <div className={styles.sidebar}>
            ...
            <div className="card">
              ...
              <button className={styles.qaBtn} onClick={() => window.print()}>📋 Export as PDF<span>›</span></button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="section">
          {loadingMood ? (
            <div style={{textAlign:'center',padding:'4rem'}}>
              ...
              <p style={{fontWeight:700,color:'var(--navy)'}}>Claude is designing your mood board...</p>
            </div>
          ) : moodboard ? (
            <div>
